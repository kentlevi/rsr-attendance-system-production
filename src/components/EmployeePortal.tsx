        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
           ...
           <div className="bg-white rounded-2xl p-6 shadow-sm border border-border flex flex-col justify-between gap-4 min-h-[340px]">
             ...
             <div className="flex-1 flex items-center justify-center py-6">
                <div className="w-24 h-24 rounded-full bg-primary/10 text-primary flex items-center justify-center">
                  <CalendarPlus size={48} strokeWidth={1.75} />
                </div>
             </div>
           ...
           <div className="bg-[#f8e5e5]/40 rounded-2xl p-6 shadow-sm border border-border flex flex-col justify-between gap-4 min-h-[240px]">
             ...
             <div className="flex-1 flex items-center justify-center py-2">
                <div className="w-24 h-24 rounded-full bg-[#DC2626]/10 text-[#DC2626] flex items-center justify-center">
                  <ClockAlert size={48} strokeWidth={1.75} />
                </div>
             </div>
